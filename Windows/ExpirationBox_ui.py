...
class Ui_ExpirationBox(object):
    def setupUi(self, ExpirationBox):
        ...
        self.gridLayout.addWidget(self.day_label, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.day_combo, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.month_label, 2, 1, 1, 1)
        ...
        self.month_combo.addItem("")
        self.month_combo.addItem("")
        self.gridLayout.addWidget(self.month_combo, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.year_combo, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.year_label, 2, 3, 1, 1)
...
"border: 0;")
        ...
        self.gridLayout.addWidget(self.qty_combo, 6, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.qty_label, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.exp_label, 1, 2, 1, 1)
    ...
    def retranslateUi(self, ExpirationBox):
        ...
        self.month_combo.setItemText(0, _translate("ExpirationBox", "1"))
        self.month_combo.setItemText(1, _translate("ExpirationBox", "2"))
        self.month_combo.setItemText(2, _translate("ExpirationBox", "3"))
        self.month_combo.setItemText(3, _translate("ExpirationBox", "4"))
        self.month_combo.setItemText(4, _translate("ExpirationBox", "5"))
        self.month_combo.setItemText(5, _translate("ExpirationBox", "6"))
        self.month_combo.setItemText(6, _translate("ExpirationBox", "7"))
        self.month_combo.setItemText(7, _translate("ExpirationBox", "8"))
        self.month_combo.setItemText(8, _translate("ExpirationBox", "9"))
        self.month_combo.setItemText(9, _translate("ExpirationBox", "10"))
