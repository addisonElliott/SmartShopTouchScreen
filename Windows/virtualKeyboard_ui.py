...
class Ui_VirtualKeyboard(object):
    def setupUi(self, VirtualKeyboard):
        ...
        VirtualKeyboard.resize(800, 334)
...
"}")
        ...
        self.leftCtrlBtn = TouchButton(VirtualKeyboard)
        self.leftCtrlBtn.setMinimumSize(QtCore.QSize(48, 48))
        self.leftCtrlBtn.setMaximumSize(QtCore.QSize(48, 48))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(15)
        self.leftCtrlBtn.setFont(font)
        self.leftCtrlBtn.setFocusPolicy(QtCore.Qt.NoFocus)
        self.leftCtrlBtn.setCheckable(True)
        self.leftCtrlBtn.setObjectName("leftCtrlBtn")
        self.horizontalLayout_5.addWidget(self.leftCtrlBtn)
        self.leftAltBtn = TouchButton(VirtualKeyboard)
        self.leftAltBtn.setMinimumSize(QtCore.QSize(48, 48))
        self.leftAltBtn.setMaximumSize(QtCore.QSize(48, 48))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(15)
        self.leftAltBtn.setFont(font)
        self.leftAltBtn.setFocusPolicy(QtCore.Qt.NoFocus)
        self.leftAltBtn.setCheckable(True)
        self.leftAltBtn.setObjectName("leftAltBtn")
        self.horizontalLayout_5.addWidget(self.leftAltBtn)
        ...
        self.rightAltBtn = TouchButton(VirtualKeyboard)
        self.rightAltBtn.setMinimumSize(QtCore.QSize(48, 48))
        self.rightAltBtn.setMaximumSize(QtCore.QSize(48, 48))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(15)
        self.rightAltBtn.setFont(font)
        self.rightAltBtn.setFocusPolicy(QtCore.Qt.NoFocus)
        self.rightAltBtn.setCheckable(True)
        self.rightAltBtn.setObjectName("rightAltBtn")
        self.horizontalLayout_5.addWidget(self.rightAltBtn)
        self.rightCtrlBtn = TouchButton(VirtualKeyboard)
        self.rightCtrlBtn.setMinimumSize(QtCore.QSize(48, 48))
        self.rightCtrlBtn.setMaximumSize(QtCore.QSize(48, 48))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(15)
        self.rightCtrlBtn.setFont(font)
        self.rightCtrlBtn.setFocusPolicy(QtCore.Qt.NoFocus)
        self.rightCtrlBtn.setCheckable(True)
        self.rightCtrlBtn.setDefault(False)
        self.rightCtrlBtn.setObjectName("rightCtrlBtn")
        self.horizontalLayout_5.addWidget(self.rightCtrlBtn)
        self.upBtn = TouchButton(VirtualKeyboard)
        self.upBtn.setMinimumSize(QtCore.QSize(48, 48))
        self.upBtn.setMaximumSize(QtCore.QSize(48, 48))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(15)
        self.upBtn.setFont(font)
        self.upBtn.setFocusPolicy(QtCore.Qt.NoFocus)
        self.upBtn.setAutoRepeat(True)
        self.upBtn.setObjectName("upBtn")
        self.horizontalLayout_5.addWidget(self.upBtn)
        self.downBtn = TouchButton(VirtualKeyboard)
        self.downBtn.setMinimumSize(QtCore.QSize(48, 48))
        self.downBtn.setMaximumSize(QtCore.QSize(48, 48))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(15)
        self.downBtn.setFont(font)
        self.downBtn.setFocusPolicy(QtCore.Qt.NoFocus)
        self.downBtn.setAutoRepeat(True)
        self.downBtn.setObjectName("downBtn")
        self.horizontalLayout_5.addWidget(self.downBtn)
...
"}")
    ...
    def retranslateUi(self, VirtualKeyboard):
        ...
        self.leftCtrlBtn.setText(_translate("VirtualKeyboard", "Ctrl"))
        self.leftAltBtn.setText(_translate("VirtualKeyboard", "Alt"))
        self.spaceBarBtn.setText(_translate("VirtualKeyboard", "Space Bar"))
        self.rightAltBtn.setText(_translate("VirtualKeyboard", "Alt"))
        self.rightCtrlBtn.setText(_translate("VirtualKeyboard", "Ctrl"))
        self.upBtn.setText(_translate("VirtualKeyboard", "↑"))
        self.downBtn.setText(_translate("VirtualKeyboard", "↓"))
